...
// Если данные с указанным ключем уже есть в хэш-отображении, функция возвращает 0, не перезаписывая старые
// данные новыми.
                            ...
                            const void *const _data)
{
    ...
    // Проверим, имеются ли в хэш-отображении данные с заданным ключем.
